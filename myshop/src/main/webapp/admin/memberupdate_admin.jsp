...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    MemberDto memberDto = memberManager.getMember(id);   // id로 회원정보 가져오기
...
<form name="updateFormAdmin" method="post" action="memberupdateproc_admin.jsp">
  <table border="1">
     <tr align="center" style="background-color: #8899aa">
         <td colspan="2"><b style="color: #FFFFFF"><%=memberDto.getName()%>회원님의 정보를 수정(관리자)</b></td>
      </tr>
      <tr>
         <td width="16%">아이디</td>
         <td width="57%">
      ...
      <tr>
         <td>우편번호</td>
         <td><input type="text" name="zipcode" size="7" value="<%= memberDto.getZipcode()%>"> <input
